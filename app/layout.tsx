...
let url = "https://GlobalTutor.com/";
let ogimage = "https://GlobalTutor.together.ai/og-image.png";
let sitename = "GlobalTutor.com";
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="h-full">
      <head>
        <PlausibleProvider domain="GlobalTutor.together.ai" />
      </head>
